  ...
  <div class="container-fluid">
    ...
    >
      <wj-flex-grid-cell-template cellType="TopLeft">
        <top-left :grid="flex" :picker="columnPicker" />
      ...
      <wj-flex-grid-column binding="products" header="PRODUCTS" />
      <wj-flex-grid-column binding="color" header="COLOR" />
      <wj-flex-grid-column binding="countryId" header="COUNTRY ID" />
      <wj-flex-grid-column binding="productId" header="PRODUCT ID" />
      <wj-flex-grid-column binding="colorId" header="COLOR ID" />
      <wj-flex-grid-column binding="amount1" header="AMOUNT1" />
      <wj-flex-grid-column binding="amount2" header="AMOUNT2" />
      <wj-flex-grid-column binding="amount3" header="AMOUNT3" />
      <wj-flex-grid-column binding="amount4" header="AMOUNT4" />
      <wj-flex-grid-column binding="amount5" header="AMOUNT5" />
      <wj-flex-grid-column binding="discount" header="DISCOUNT" />
    ...
    <input-text type="text" placeholder="Default" />
  </div>
</template>
